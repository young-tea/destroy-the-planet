...
function clickCounter() {
	...
	document.getElementById('clicks').innerHTML = "You clicked " + clicks + " times!";
...
function planetClick() {
	...
	document.getElementById('planetClicks').innerHTML = "You clicked this planet " + planetClicks + " times!";
...
function planetDestroy() {
	...
	document.getElementById('planets').innerHTML = "You destroyed " + planets + " planets!";
